...
function renderAdminTodayTimeline() {
        ...
        list.innerHTML =
            `
                ...
                <div class="admin-timeline-empty">
                    ...
                    <span>
                        Today's booked visits will appear here automatically.
                    </span>
                ...
                visit => {
                    ...
                    return `
                        ...
                        <article
                            ...
                            data-timeline-visit-id="${visit.id}"
                        >
                            ...
                            <span class="admin-timeline-item-status">
                                ${escapeHtml(
                                    statusLabel
                                )}
                            </span>

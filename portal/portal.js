...
//
//   not claimed + 2 or more visits
//       -> thin strip on Home,
//          under the greeting
//
//   claimed, waiting, or paid
...
// GOOGLE_REVIEW_URL
//
//   Your "write a review" link. Google
//   Business Profile -> Ask for reviews.
//
// REVIEW_MIN_VISITS
//
//   Completed visits before a client is asked,
...
// ========================================
// LATEST UPDATE PHOTO RELIABILITY
// ========================================
//
// Fixes two things:
//
// 1. Overlapping renders. The Home dashboard
//    is redrawn from load, tab changes and two
//    realtime channels. Runs are now queued so
//    one can't clear the photo while another
//    is still fetching.
//
// 2. Stale signed URLs. They expire after an
//    hour, so the page is refreshed when it
...
const originalRenderMobileHomeForQueue =
    renderMobileHomeDashboard;
    ...
    function () {
        ...
        homeRenderQueue =
            homeRenderQueue
                .then(
                    () =>
                        originalRenderMobileHomeForQueue()
                )
                .catch(
                    error => {
        ...
        return homeRenderQueue;

    };


// ========================================
// HIDE A PHOTO THAT FAILED TO LOAD
// ========================================
//
// Better an absent photo than a tall empty
// white box.
// ========================================
...
document.addEventListener(
    ...
    event => {
        ...
        const photoBox =
            image.closest(
                ".mobile-home-latest-update-photo, .desktop-latest-update-photo"
            );
        ...
        console.warn(
            "Latest update photo failed to load."
        );
...
// ========================================
// REFRESH WHEN THE APP COMES BACK
// ========================================

let lastHomeRenderAt =
    Date.now();
